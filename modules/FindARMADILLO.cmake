...
#  ARMADILLO_INCLUDE_DIR - list of required include directories
#  ARMADILLO_LIBRARY - list of libraries to be linked
#  ARMADILLO_LIB_DIR - list of libraries to be linked
...
find_path(ARMADILLO_INCLUDE_DIR armadillo
  PATHS ${ARMADILLO_DIR}/include ${ARMADILLO_DIR}
...
find_library(ARMADILLO_LIBRARY armadillo
  PATHS ${ARMADILLO_DIR}/lib ${ARMADILLO_DIR}
  PATH_SUFFIXES lib
  NO_DEFAULT_PATH)
find_library(ARMADILLO_LIBRARY armadillo
  PATH_SUFFIXES lib)
...
if (ARMADILLO_LIBRARY)
  get_filename_component(ARMADILLO_LIB_DIR ${ARMADILLO_LIBRARY} PATH)
