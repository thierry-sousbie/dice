...
class NDnetFilter_subsetsT : 
  public internal::NDnetFilter_domainIndexedBaseT<M>
{
public:
  ...
  NDnetFilter_subsetsT(M *mesh, int *initMeshResolution,
		       ...
		       const char *domainIndex="domainIndex"):
    Base(mesh,initMeshResolution,domainIndex)    
  { 
  ...
  Simplex *operator()(Simplex *s) const
  {
    ...
    if (result) return s;
    else return static_cast<Simplex*>(NULL);
  }
private:
...
class NDnetFilter_lagrangianLinesT : 
  public internal::NDnetFilter_domainIndexedBaseT<M>
{
public:
  typedef internal::NDnetFilter_domainIndexedBaseT<M> Base;
...
// 3D
template <class M>
class NDnetFilter_lagrangianLinesT<M,3> : 
  public internal::NDnetFilter_domainIndexedBaseT<M>
{
public:
  typedef internal::NDnetFilter_domainIndexedBaseT<M> Base;
