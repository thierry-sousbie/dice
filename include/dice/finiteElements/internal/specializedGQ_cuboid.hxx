...
namespace internal
{
  namespace gaussQuadrature
  {
    ...
    template <typename T>
    struct CuboidPoints<2, T> : public CuboidPoints<3, T>
    {
    };
    ...
    template <typename T>
    struct CuboidPoints<4, T> : public CuboidPoints<5, T>
    {
    };
    ...
    template <typename T>
    struct CuboidPoints<6, T> : public CuboidPoints<7, T>
    {
    };
    ...
    template <typename T>
    struct CuboidPoints<8, T> : public CuboidPoints<9, T>
    {
    };
