...
namespace internal {
  namespace gaussQuadrature {
    ...
    template <>
    struct SpecializedGQT<1,2,fETypeE::cuboid> :
      public SpecializedGQT<1,3,fETypeE::cuboid>
    {};
	...
	return 
	  W1*(functor(0.5*(1.0-A))+functor(0.5*(1.0+A)))+
	  W2*functor(0.5);
      }      
    };
    template <>
    struct SpecializedGQT<1,4,fETypeE::cuboid> :
      public SpecializedGQT<1,5,fETypeE::cuboid>
    {};
    ...
    template <>
    struct SpecializedGQT<1,6,fETypeE::cuboid> :
      public SpecializedGQT<1,7,fETypeE::cuboid>
    {};
    ...
    template <>
    struct SpecializedGQT<1,8,fETypeE::cuboid> :
      public SpecializedGQT<1,9,fETypeE::cuboid>
    {};
