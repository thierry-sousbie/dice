...
public:
  ...
  */
  ...
  {
    return predicate::IntersectionSegmentFacetT<NDIM, filter>::template test<MyType, G, TZ, TC>(*this, coords, dim, otherCoord, geometry, intersectionCoord, coordsAreConsistent);
  }
  ...
  int intersectSegment(const Coord *coords, int dim, Coord otherCoord,
                       ...
                       int coordsAreConsistent = -1) const
  {
    return predicate::IntersectionSegmentFacetT<NDIM, filter>::template test<MyType, G>(*this, coords, dim, otherCoord, geometry, coordsAreConsistent);
  }
