...
namespace internal
{
  namespace lrg
  {
    ...
    public:
      ...
      SymmetryFunctorInterface(G *g) : m_grid(g)
      {
      }
    ...
    class SymmetryFunctorSinglePlane : public SymmetryFunctorInterface<G>
    {
    ...
    public:
      ...
      SymmetryFunctorSinglePlane(G *g) : Base(g)
      {
    ...
    class SymmetryFunctorDualPlane : public SymmetryFunctorInterface<G>
    {
    ...
    public:
      ...
      SymmetryFunctorDualPlane(G *g) : Base(g)
      {
    ...
    template <class G>
    class SymmetryFunctorTriplePlane : public SymmetryFunctorInterface<G>
    {
    ...
    public:
      ...
      SymmetryFunctorTriplePlane(G *g) : Base(g)
      {
        sz0_m1 = g->getValueCoord(Index0).size();
        halfSz0 = sz0_m1 / 2;
        sz0_m1--;
    ...
    class SymmetryFunctorConstant : public SymmetryFunctorInterface<G>
    {
      static const int NDIM = G::NDIM;
      static const int Index = hlp::MinT<G::NDIM - 1, I>::value;
    ...
    public:
      ...
      SymmetryFunctorConstant(G *g) : Base(g)
      {
    ...
    // CENTRAL symmetry
    template <class G>
    class SymmetryFunctorCentral : public SymmetryFunctorInterface<G>
    {
      static const int NDIM = G::NDIM;
    ...
    public:
      ...
      SymmetryFunctorCentral(G *g) : Base(g)
      {
