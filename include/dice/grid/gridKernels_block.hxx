...
namespace gridKernel{
  ...
  protected:
    ...
    {  
      ...
      for (int i=0;i<ND;++i)
	{
	  if (pos[i]<HALF_SIZE_LEFT) mask |= (1<<i);
	  if (pos[i]>(dim[i]-HALF_SIZE_RIGHT_PLUS_ONE)) mask |= (1<<(i+ND));
	} 
