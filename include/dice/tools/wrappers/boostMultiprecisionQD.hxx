...
namespace boost
{
  namespace multiprecision
  {
    ...
    // struct number_category<backends::dd_backend> : public mpl::int_<number_kind_floating_point>
    // {
    // };

    // template <>
    // // struct number_category<dd_real> : public std::integral_constant<int, number_kind_floating_point>
    // struct number_category<dd_real> : public mpl::int_<number_kind_floating_point>
    // {
    // };
    ...
    // template <>
    // struct number_category<backends::qd_backend> : public mpl::int_<number_kind_floating_point>
    // {
    // };

    // template <>
    // struct number_category<qd_real> : public mpl::int_<number_kind_floating_point>
    // {
    // };
