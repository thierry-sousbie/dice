      ...
      namespace multiprecision
      {
            namespace backends
            {
                  ...
                  public:
                        ...
                        template <class T>
                        qd_backend(const T &i, const typename enable_if_c<std::is_convertible<T, qd_real>::value>::type * = 0) BOOST_NOEXCEPT
                            : m_value(i) {}
                        template <class T>
                        typename enable_if_c<is_arithmetic<T>::value || std::is_convertible<T, qd_real>::value, qd_backend &>::type operator=(const T &i) BOOST_NOEXCEPT
                        {
                              m_value = i;
                              return *this;
                        }
                  ...
                  */
                  ...
                  inline bool eval_lt(const qd_backend &a, double b) { return a.m_value < b; }
                  inline bool eval_gt(const qd_backend &a, double b) { return a.m_value > b; }
                  inline bool eval_eq(const qd_backend &a, double b) { return a.m_value == b; }

            } // namespace backends

            template <>
            struct number_category<backends::qd_backend> : public std::integral_constant<int, number_kind_floating_point>
            {
            };

            template <>
            struct number_category<qd_real> : public std::integral_constant<int, number_kind_floating_point>
            {
            };
