...
public:
  ...
  UnionIterator2T(const IA &beginA_, const IA &endA_, const IB &beginB_, const IB &endB_) : curA(beginA_), curB(beginB_),
                                                                                            endA(endA_), endB(endB_)
  {
  }

  UnionIterator2T(const IA &endA_, const IB &endB_) : curA(endA_), curB(endB_),
                                                      endA(endA_), endB(endB_)
  {
  }
...
public:
  ...
  UnionIterator3T(const IA &beginA_, const IA &endA_, const IB &beginB_, const IB &endB_, const IC &beginC_, const IC &endC_) : curA(beginA_), curB(beginB_), curC(beginC_),
                                                                                                                                endA(endA_), endB(endB_), endC(endC_)
  {
  }

  UnionIterator3T(const IA &endA_, const IB &endB_, const IC &endC_) : curA(endA_), curB(endB_), curC(endC_),
                                                                       endA(endA_), endB(endB_), endC(endC_)
  {
  }
